...
@Service
public class CalculosFormularioServiceImpl implements NumerosService {
    /**
     * @return String
     * <p>
     ...
     * @return Double
     * <p>
     * Esta clase se encarga de devolver la hipotenusa de un triángulo después de pasarle los valores de sus catetos
     */
    @Override
     ...
     * @return String
     * <p>
     * Esta clase se encarga de devolver una Lista de números aleatorios ordenados y sin repetir
     */
    @Override
     ...
     * @return String
     * <p>
     * Esta clase se encarga de devolver una lista de divisores del número que solicites.
     */
    @Override
